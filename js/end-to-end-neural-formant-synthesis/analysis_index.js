...
const speaker_names = analysis_synthesis[0].contents.map((speaker) => speaker.name);

const analysis_path = analysis_synthesis[0].name.replace("static", "");

const sample_names = analysis_synthesis[0].contents[0].contents.filter((model) => model.name === "ref")[0].contents.map((sample) => sample.name.replace(".wav", ""));
